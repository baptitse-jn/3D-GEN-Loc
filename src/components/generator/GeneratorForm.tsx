...
interface GeneratorFormProps {
  ...
  setOptions: (options: ModelGenerationOptions) => void;
  onGenerate: () => void;
...
export const GeneratorForm: React.FC<GeneratorFormProps> = ({
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg p-6">
      <h2 className="text-2xl font-bold mb-6">Créer votre modèle 3D</h2>
      ...
      <div className="space-y-4">
        ...
        >
          ...
          {isGenerating ? 'Génération en cours...' : 'Générer le modèle'}
        </Button>
      </div>
    </div>
  );
